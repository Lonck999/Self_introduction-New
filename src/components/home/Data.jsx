  ...
  return (
    <div className="home_data">
      ...
      <p className="home_description">
        您好，我叫做蕭浩廷，目前剛從資策會前端培訓班結訓，在樂天時因經常接觸下有興趣並投身到這產業，目前會HTML、CSS、SASS、JS、bootstrap、React也有接觸過一些後端的東西像是MySQL、Node.js，目前版本控管是用Git、Github，在培訓班期間也有跟幾位業界朋友一起接案，實際接觸案子如果從無到有運作運行，邊做邊學，目前已接過兩個案子都是用(Vue)，React的部分在結訓專題上也有實際操做過.
        <br />
      </p>
      <div className="home_subtitle-button">
        <a href="#contact" className="button button--flex shadow unit">
          Say Hello
          <i class="uil uil-message home_icon-button"></i>
        </a>
      </div>
    </div>
  );
